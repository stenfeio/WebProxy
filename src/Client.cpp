...
int main(int argc, char* argv[])
{
  try
  {
    ...
    //curlpp::options::Url(std::string("www.google.com"));

    std::string rr = "get http://www.brainjar.com/java/host/test.html HTTP/1.1\r\n"
		    "Host: www.brainjar.com\r\n"
		    ...
		    "\r\n";
    boost::asio::write(socket,boost::asio::buffer(rr), ignore_error);
